...
temp_boxes = boxes.tolist()
temp_box = boxIdxs[0].tolist()

index = temp_boxes.index(temp_box)


temp_proba = proba[index]

startX, startY, endX, endY = boxIdxs[0]
cv2.rectangle(clone2, (startX, startY), (endX, endY),(0, 255, 0), 2)

y = startY - 10 if startY - 10 > 10 else startY + 10

text= "Raccoon: {:.2f}%".format(temp_proba * 100)
